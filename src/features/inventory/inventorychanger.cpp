...
void InventoryChanger::renderInventoryChangerWindow() noexcept {
    ...
    if (isInAddMode) {
        ...
        if (ImGui::BeginChild("##scrollarea", ImVec2 { 0.0f, 0.0f })) {
        ...
        if (ImGui::BeginChild("##scrollarea2", ImVec2 { 0.0f, 0.0f })) {
