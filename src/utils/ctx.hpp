...
public:
	...
	{			
		...
		bool exploits = false;
		bool next_tick_lby_update = false;
		bool scoped = false;
		...
		bool should_modify_eye_position = false;
	...
	player_t* local(player_t* e = nullptr, bool fsn = false);
