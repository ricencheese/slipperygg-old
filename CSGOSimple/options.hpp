...
public:
		...
		//Aimbot
		//
		OPTION(bool, aim_backtrack_enabled, false);
		OPTION(int, aim_backtrack_amount, 200);
		...
		OPTION(float, misc_nightmode_amount, 0.65f);
		...
		// COLORS
		// 
		OPTION(Color, color_nightmode, Color(0, 0, 0));
		...
		OPTION(Color, color_menu_background, Color(0.f, 0.f, 0.f, 0.940f));
		...
		OPTION(Color, color_watermark, Color(255, 209, 220)); // no menu config cuz its useless
};
