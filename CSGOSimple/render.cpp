...
void Render::GetFonts() {
	...
	ImGui::GetIO().Fonts->AddFontFromMemoryCompressedBase85TTF(
		Fonts::Helvetica_compressed_data_base85,
...
void Render::BeginScene() {								//watermark render thingy
	draw_list->Clear();
	draw_list->PushClipRectFullScreen();


	if (g_Options.misc_watermark)//text-------	pos--  size  color--------------------centered border font
		Render::Get().RenderText("slippery.gg", 10, 5, 18.f, g_Options.color_watermark, false, true, g_pSecondFont);
